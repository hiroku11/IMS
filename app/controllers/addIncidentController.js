var addIncidentController = riskManagementSystem.controller("addIncidentController", ["$scope", "AppService", "rmsService", '$location', '$window', '$http', '$state', 'dateformatterFilter',
    function ($scope, AppService, rmsService, $location, $window, $http, $state, dateformatterFilter) {
        ...
        $scope.loss = {
            ...
            "statusFlag": "ACTIVE",
            "date": new Date(),
            "timeHrsContacted": (new Date().getHours()).length == 2 ? new Date().getHours() : '0' + (new Date().getHours()),
            "timeMinContacted": (new Date().getMinutes()).length == 2 ? new Date().getMinutes() : '0' + (new Date().getMinutes()),
            "externalAgency": { }
    }
...
$scope.crimeDetails = {
    ...
    "anyWitness": null,
    "date": new Date(),
    "timeHrs": (new Date().getHours()).length == 2 ? new Date().getHours() : '0' + (new Date().getHours()),
    "timeMin": (new Date().getMinutes()).length == 2 ? new Date().getMinutes() : '0' + (new Date().getMinutes()),
    "witnesses": [],
    "crimeSuspects": []
}
$scope.crimesuspects = [];
